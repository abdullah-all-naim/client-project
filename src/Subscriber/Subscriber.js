...
const Subscriber = () => {
    return (
        <div className='container mb-5' style={{ borderRadius: '20px', textAlign: 'center', padding: '15px 0px 10px', fontFamily: "Comic Neue, cursive", fontSize: '20px' }}>
            ...
            <div className='col-12 col-md-8 col-lg-5 m-auto' style={{ backgroundColor: 'rgba(243, 52, 89, 1)', borderTop: '1px solid white', borderBottom: '1px solid white', borderRadius: '10px', color: 'white', }}>
