...
const Subscriber = () => {
    return (
        <div className='container mb-5' style={{ borderRadius:'20px', textAlign:'center', padding:'15px 0px 10px',fontFamily: "Comic Neue, cursive", fontSize:'20px'}}>
            ...
            <div className='col-6 col-md-3 m-auto' style={{backgroundColor: 'rgba(243, 52, 89, 1)', borderTop: '1px solid white', borderBottom: '1px solid white', borderRadius:'10px', color: 'white', fontSize:'16px', padding: ''}}>
                <p className='text-center mt-2 font-weight-bold' style={{fontFamily:'Calisto MT'}}>Mulai Sekarang <br/> Kita Se-SOHIB Seperjuangan!</p>
            </div>
        </div>
    );
};
